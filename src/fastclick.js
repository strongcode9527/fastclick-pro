...
FastClick.prototype.focus = function(targetElement) {
  ...
  if (deviceIsIOS && targetElement.setSelectionRange && targetElement.type.indexOf('date') !== 0 && targetElement.type !== 'time' && targetElement.type !== 'month' && targetElement.type !== 'email' && !isTypeElement(targetElement)) {
...
FastClick.prototype.touchHasMoved = function(event) {
  const touch = event.changedTouches[0], boundary = this.touchBoundary;
...
FastClick.prototype.onTouchEnd = function(event) {
  ...
  if (targetTagName === 'label') {
    ...
    if ((!deviceIsIOS || targetTagName !== 'select') && !isTypeElement(targetElement)) {
      this.targetElement = null;
      event.preventDefault();
    }
